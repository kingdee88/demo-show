        ...
        <Card>
            <div slot="title">
                <div class="edit-head">
                    ...
                    <div class="head-name">固定资产维保确认单</div>
                    <span></span>
                    ...
                    <Col span="24" style="border-right: 1px solid rgba(233, 232, 233, 0.6);">
                        <Form ref="form" :model="apply" :label-width="120" :rules="formValidate">
                            ...
                            <Row :gutter="32">
                                ...
                                <Col span="24">
                                    <FormItem label="维保情况" prop="detail">
                                        <Input type="textarea" v-model="apply.detail" :rows="4" />
                                    </FormItem>
                                </Col>
                            </Row>
                            <Form-item class="br">
        ...
        methods: {
            ...
            actionSelect(){
                ...
                this.apply = {
                    ...
                    bindex: 1, ibalance: 256489, ckmeter: 23378, lkmeter: 13579
                };
            }
        },
        mounted() {
