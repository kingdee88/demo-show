...
<template>
    <div class="search">
        ...
        <Card v-show="currView=='index'">
            <Row class="operation">
                <Button @click="add" type="primary" icon="md-add">劳务费申请</Button>
                <Button type="primary" icon="ios-checkbox-outline">劳务费申请审核</Button>
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                axios.get('/mock/laowufeishenqing.json').then(res => {
