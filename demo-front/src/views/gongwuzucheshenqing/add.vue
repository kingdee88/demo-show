    ...
    <Card>
      <div slot="title">
        <div class="edit-head">
          ...
          <div class="head-name">公务租车申请</div>
          <span></span>
      ...
      <Card>
        <p class="show-info">经办人部门：{{form.APPLY_DEPT_NAME}}   经办人：demo   申请日期：{{form.TIME_CREATE}}   申请单号：送审后自动生成</p>
        <Row type="flex" justify="space-between" :gutter="32">
          <Col :xl="21" :xxl="16"  style="border-right: 1px solid rgba(233, 232, 233, 0.6);">
            <Form ref="form" :model="form" :label-width="120" :rules="formValidate">
              ...
              <Row :gutter="32">
                ...
                <Col span="12">
                  <FormItem label="拟参与人数" prop="name">
                    <Input v-model="form.name" style="width: 280px"/>
                  </FormItem>
                </Col>
                <Col span="24">
              ...
              <h4 class="h4-title">租车用车信息</h4>
              <Row :gutter="32">
                <Col span="12">
                  <FormItem label="用车时间" prop="name">
                    <DatePicker
                            v-model="form.date"
                            type="datetime"
                            format="yyyy-MM-dd"
                ...
                <Col span="24">
                  <FormItem label="用车时长" prop="name">
                    <Input v-model="form.description" style="width: 280px"/>
                  </FormItem>
                </Col>
              </Row>
              <h4 class="h4-title" style="padding-top: 12px;">用车地点信息</h4>
              <Table
                      border
                      :columns="columns3"
                      :data="datas3"
                      ...
                      ref="table"
              ></Table>
              <h4 class="h4-title" style="padding-top: 12px;">乘用人员信息</h4>
              <Table
                      border
                      :columns="columns4"
                      :data="datas4"
                      ...
                      ref="table"
              ></Table>
              <h4 class="h4-title">租车信息</h4>
              <Row :gutter="32">
                <Col span="12">
                  <FormItem label="出租车辆单位" prop="name">
                    <Input v-model="form.name" style="width: 320px">
                      <Button slot="append" icon="ios-bookmarks"></Button>
                    </Input>
                  </FormItem>
                ...
                <Col span="12">
                  <FormItem label="出租车总金额" prop="name">
                    <Input v-model="form.AGENT_USER_NAME" style="width: 320px">
                      <Button slot="append" icon="ios-person"></Button>
                    </Input>
                  </FormItem>
