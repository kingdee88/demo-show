...
<template>
    <div class="search">
        ...
        <Card v-show="currView=='index'">
            <Row class="operation">
                <Button @click="add" type="primary" icon="md-add">公务租车申请</Button>
                <Button type="primary" icon="ios-checkbox-outline">公务租车申请审核</Button>
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                axios.get('/mock/gongwuzucheshenqing.json').then(res => {
