                    ...
                    <Col span="16" style="border-right: 1px solid rgba(233, 232, 233, 0.6);">
                        <Form ref="form" :model="form" :label-width="120" :rules="formValidate">
                          ...
                          <Row :gutter="32">
                              ...
                              <Col span="12">
                                <FormItem label="培训类型" prop="name">
                                  <Select
                                          v-model="form.type"
                                          placeholder="请选择"
                                  >
                                    <Option value="0">短训(15天内)</Option>
                                  </Select>
                                </FormItem>
                              </Col>
                              <Col span="24">
                                <FormItem label="培训举办机构" prop="name">
                                  <Input v-model="form.name" ></Input>
                                </FormItem>
                              </Col>
                              <Col span="24">
                                <FormItem label="培训起止日期" prop="name">
                                  <DatePicker
                                          v-model="form.date"
                                          type="daterange"
                                          format="yyyy-MM-dd"
                                          clearable
                                          placeholder="选择培训起止日期"
                                          style="width: 320px"
                                  ></DatePicker>
                                </FormItem>
                              </Col>
                              ...
                              <Col span="12">
                                <FormItem label="培训天数" prop="name">
                                  <Input v-model="form.name" style="width: 320px"/>
                                </FormItem>
                              </Col>
                               <Col span="12">
                                <FormItem label="培训地点" prop="name">
                                   <Select
                                          v-model="form.type"
                                          placeholder="请选择"
                                  >
                              ...
                              <Col span="24">
                                <FormItem label="培训地点说明" prop="name">
                               ...
                               <Col span="24">
                                <FormItem label="参加培训人员" prop="name">
                                  <Input v-model="form.name" >
                                  </Input>
                                </FormItem>
                              </Col>
