        ...
        <Card>
            <div slot="title">
                <div class="edit-head">
                    ...
                    <div class="head-name">供应商登记单</div>
                    <span></span>
                    ...
                    <Col span="16" style="border-right: 1px solid rgba(233, 232, 233, 0.6);">
                        <Form ref="form" :model="form" :label-width="120" :rules="formValidate">
                            ...
                            <Row :gutter="32">
                              ...
                              <Col span="12">
                                <FormItem label="采购申请单" prop="name">
                                  <Input v-model="form.name" style="width: 320px">
                                  </Input>
                                </FormItem>
                              </Col>
                            ...
                            <Row :gutter="32">
                                <Col span="12">
                                  ...
                                  <Col span="12">
                                    <FormItem label="社会统一信用代码" prop="name">
                                      <Input v-model="form.name" style="width: 320px">
                                      </Input>
                                    </FormItem>
                                </Col>
                              ...
                              <Col span="12">
                               ...
                               <Col span="12">
                                <FormItem label="注册地类型" prop="name">
                                    <Select
                                          v-model="form.type"
                                          placeholder="请选择"
                                  >
                               ...
                               <Col span="12">
                                <FormItem label="开户行名称" prop="name">
                                  <Input v-model="form.name" style="width: 320px">
                                  </Input>
                                </FormItem>
                              </Col>
                               <Col span="12">
                                <FormItem label="开户行账号" prop="name">
                                  <Input v-model="form.name" style="width: 320px">
                                  </Input>
                                </FormItem>
                              </Col>
                               <Col span="24">
                                <FormItem label="采购预算金额(元)" prop="name">
                                  <Input v-model="form.name" style="width: 320px">
                                  </Input>
                                </FormItem>
                              </Col>
                               <Col span="24">
                                <FormItem label="采购金额(元)" prop="name">
                                  <Input v-model="form.name" style="width: 320px">
                                  </Input>
                                </FormItem>
                              </Col>
                               <Col span="12">
                                <FormItem label="结余金额(元)" prop="name">
                                  <Input v-model="form.name" style="width: 320px">
                                  </Input>
                                </FormItem>
                              </Col>
                               <Col span="12">
                                <FormItem label="结余资金率" prop="name">
                                  <Input v-model="form.name" style="width: 320px">
                                  </Input>
                                </FormItem>
                              </Col>
