...
<template>
    <div class="search">
        ...
        <add1 v-if="currView=='add1'" @close="currView='index'" @submited="submited1"/>
                ...
                <div style="display: flex;justify-content: space-between;">
                    <Form>
                        <Form-item class="br" label="">
                            <Button @click="add" type="primary" icon="md-add">油卡加油</Button>
                            <Button @click="add1" type="primary" icon="md-add">临时加油</Button>
                        </Form-item>
                    </Form>
                    <Form
                            ref="searchForm"
