                    ...
                    <Col span="16" style="border-right: 1px solid rgba(233, 232, 233, 0.6);">
                        <Form ref="form" :model="form" :label-width="120" :rules="formValidate">
                            ...
                            <Row :gutter="32">
                                ...
                                <Col span="12">
                                    <FormItem label="会员类型" prop="name">
                                        <Select
                                                style="width: 320px"
                                                v-model="form.type"
                                                placeholder="请选择"
                                        >
                                            <Option :value="0">一类会议</Option>
                                            <Option :value="1">二类会议</Option>
                                            <Option :value="2">三类会议</Option>
                                            <Option :value="3">四类会议</Option>
                                        </Select>
                                    </FormItem>
                                </Col>
                                <Col span="12">
                                    <FormItem label="会议召开方式" prop="name">
                                        <Select
                                                style="width: 320px"
                                                v-model="form.type"
                                                placeholder="请选择"
                                        >
                                            <Option :value="0">现场会议</Option>
                                            <Option :value="1">网络电话会议</Option>
                                ...
                                <Col span="12">
                                    <FormItem label="会议召开日期" prop="name">
                                        <DatePicker
                                                v-model="form.date"
                                                type="daterange"
                                                format="yyyy-MM-dd"
                                ...
                                <Col span="12">
                                    <FormItem label="会议召开地点" prop="name">
                                        <Select
                                                style="width: 320px"
                                                v-model="form.address"
                                                placeholder="请选择"
                                        >
                                            <Option :value="0">单位会议室</Option>
                                            <Option :value="1">定点酒店</Option>
                                            <Option :value="3">其他</Option>
                                        </Select>
                                    </FormItem>
                                </Col>
                                <Col span="24">
                                    <FormItem label="会议地点说明" prop="name">
                                        <Input v-model="form.name" style="width: 320px">
                                            <Button slot="append" icon="ios-bookmarks"></Button>
                                        </Input>
                                    </FormItem>
                                ...
                                <Col span="24">
                                    <FormItem label="主要参会人员" prop="name">
                                        <Input v-model="form.name" style="width: 320px"/>
                                    </FormItem>
                                </Col>
                                <Col span="12">
                                    <FormItem label="参会人数" prop="name">
                                        <Input v-model="form.name" style="width: 320px"/>
                                    </FormItem>
                                </Col>
                                <Col span="12">
                                    <FormItem label="工作人员数量" prop="name">
                                        <Input v-model="form.name" style="width: 320px"/>
                                    </FormItem>
                                </Col>
                                <Col span="12">
                                    <FormItem label="本单位人数" prop="name">
                                        <Input v-model="form.name" style="width: 320px"/>
                                    </FormItem>
                                </Col>
                                <Col span="12">
                                    <FormItem label="其他单位人数" prop="name">
                                        <Input v-model="form.name" style="width: 320px"/>
                                    </FormItem>
                                </Col>
                                <Col span="24">
                                    <FormItem label="会议内容" prop="name">
                                        <Input
                                                type="textarea"
                                                v-model="form.description"
                                                :rows="4"
